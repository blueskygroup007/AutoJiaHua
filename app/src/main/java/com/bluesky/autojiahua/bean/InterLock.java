package com.bluesky.autojiahua.bean;
...
public class InterLock implements Serializable {
    ...
    public InterLock(@NotNull Integer number, String domain, String device_name, String tag, String control_value, String interlock_device_name, String interlock_device_tag, String action_type, String remark) {
        this.number = number;
        this.domain = domain;
